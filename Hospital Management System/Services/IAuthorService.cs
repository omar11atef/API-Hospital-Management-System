...
{
    Task<Result<AuthorResponse>> IsAuthorCorrectAysun(string email, string password,CancellationToken cancellationToken);
    ...
    Task<Result> ResetPasswordAsync(ResendPasswordRequestApp request);
}
